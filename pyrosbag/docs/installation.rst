...
The sources for ROS Bag Python Controller can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/masasin/pyrosbag
.. _tarball: https://github.com/masasin/pyrosbag/tarball/master
